...
{
    public class StyleMetroDark : Style
    {
        #region private static members
        private static Color _backgroundColor = ColorUtility.ColorFromRGB(10, 10, 20);
        private static Color _backgroundBoderColor = ColorUtility.ColorFromRGB(90, 90, 90);

        #region Buttons
        private static Color _buttonPressedBorder = ColorUtility.ColorFromRGB(100, 100, 100);
        private static Color _buttonPressedBack = ColorUtility.ColorFromRGB(220, 220, 220);
        private static Color _buttonPressedTextColor = ColorUtility.ColorFromRGB(100, 100, 100);

        private static Color _buttonEnabledBack = ColorUtility.ColorFromRGB(48, 47, 55);
        private static Color _buttonEnabledTextColor = ColorUtility.ColorFromRGB(213, 213, 213);

        private static Color _buttonDisabledBack = ColorUtility.ColorFromRGB(29, 28, 33);
        private static Color _buttonDisabledTextColor = ColorUtility.ColorFromRGB(113, 113, 113);
        #endregion

        #region TextBoxes
        private static Color _textBoxPressedBack = ColorUtility.ColorFromRGB(120, 120, 120);
        private static Color _textBoxPressedTextColor = ColorUtility.ColorFromRGB(30, 30, 30);
        ...
        private static Color _textBoxEnabledBack = ColorUtility.ColorFromRGB(205, 205, 205);
        private static Color _textBoxEnabledTextColor = ColorUtility.ColorFromRGB(60, 60, 60);

        private static Color _textBoxDisabledBack = ColorUtility.ColorFromRGB(29, 28, 33);
        ...
        #region CheckBox
        private static Color _checkBoxEnabledBack = ColorUtility.ColorFromRGB(205, 205, 205);
        private static Color _checkBoxEnabledCross = ColorUtility.ColorFromRGB(33, 33, 33);
        ...
        private static Color _checkBoxPressedBack = ColorUtility.ColorFromRGB(190, 190, 190);
        ...
        #region ProgressBar
        private static Color _progressBarEnabledBack1 = ColorUtility.ColorFromRGB(89, 89, 89);
