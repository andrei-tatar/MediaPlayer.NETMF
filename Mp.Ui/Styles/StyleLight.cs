...
namespace Mp.Ui.Styles
{
    public class StyleLight : Style
    {
        ...
        private static Color _backgroundColor = ColorUtility.ColorFromRGB(240, 240, 245);
        private static Color _backgroundBoderColor = Colors.DarkGray;

        #region Button
        private static Color _buttonPressedBorder = ColorUtility.ColorFromRGB(155, 155, 155);
        private static Color _buttonPressedBack1 = ColorUtility.ColorFromRGB(135, 135, 140);
        private static Color _buttonPressedBack2 = ColorUtility.ColorFromRGB(35, 35, 40);
        private static Color _buttonPressedTextColor = ColorUtility.ColorFromRGB(155, 155, 155);

        private static Color _buttonEnabledBorder = ColorUtility.ColorFromRGB(210, 210, 215);
        private static Color _buttonEnabledBack1 = ColorUtility.ColorFromRGB(250, 250, 255);
        private static Color _buttonEnabledBack2 = ColorUtility.ColorFromRGB(230, 230, 235);
        private static Color _buttonEnabledTextColor = ColorUtility.ColorFromRGB(42, 42, 42);

        private static Color _buttonDisabledBorder = ColorUtility.ColorFromRGB(190, 190, 190);
        private static Color _buttonDisabledBack1 = ColorUtility.ColorFromRGB(226, 227, 222);
        private static Color _buttonDisabledBack2 = ColorUtility.ColorFromRGB(200, 200, 200);
        private static Color _buttonDisabledTextColor = ColorUtility.ColorFromRGB(100, 100, 100);
        #endregion

        #region TextBox
        private static Color _textBoxPressedBorder = ColorUtility.ColorFromRGB(155, 155, 155);
        private static Color _textBoxPressedBack1 = ColorUtility.ColorFromRGB(35, 35, 35);
        private static Color _textBoxPressedBack2 = ColorUtility.ColorFromRGB(35, 35, 35);
        private static Color _textBoxPressedTextColor = ColorUtility.ColorFromRGB(155, 155, 155);
        ...
        private static Color _textBoxEnabledBorder = ColorUtility.ColorFromRGB(130, 130, 130);
        ...
        private static Color _checkBoxEnabledBack1 = ColorUtility.ColorFromRGB(250, 250, 250);
        private static Color _checkBoxEnabledBack2 = ColorUtility.ColorFromRGB(230, 230, 230);
        private static Color _checkBoxEnabledCross = ColorUtility.ColorFromRGB(60, 60, 60);

        private static Color _checkBoxDisabledBorder = ColorUtility.ColorFromRGB(0, 0, 0);
        private static Color _checkBoxDisabledBack1 = ColorUtility.ColorFromRGB(29, 28, 33);
        private static Color _checkBoxDisabledBack2 = ColorUtility.ColorFromRGB(29, 28, 33);
        private static Color _checkBoxDisabledCross = ColorUtility.ColorFromRGB(113, 113, 113);

        private static Color _checkBoxPressedBorder = ColorUtility.ColorFromRGB(155, 155, 155);
        private static Color _checkBoxPressedBack1 = ColorUtility.ColorFromRGB(250, 250, 250);
        private static Color _checkBoxPressedBack2 = ColorUtility.ColorFromRGB(250, 250, 250);
        private static Color _checkBoxPressedCross = ColorUtility.ColorFromRGB(180, 180, 180);
        #endregion
        ...
        #region ProgressBar
        public override Color ProgressBarEnabledBack1 { get { return _backgroundColor; } }
        public override Color ProgressBarEnabledBack2 { get { return Colors.LightGray; } }
        ...
        public override Color ProgressBarDisabledBack2 { get { return Colors.LightGray; } }
        public override Color ProgressBarDisabledBorder { get { return Colors.DarkGray; } }

        public override Color ProgressBarBack1 { get { return Colors.LightGreen; } }
        public override Color ProgressBarBack2 { get { return Colors.LightGreen; } }
        #endregion
